...
namespace DataModelsLibrary.Migrations
{
    ...
    [Migration("20231023082108_Transaction_Migration")]
    partial class Transaction_Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseContext.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DatabaseContext.TransferPointsQueue", b =>
                {
                    ...
                    b.Property<int?>("TransferPointsQueueTypeId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TransferPointsQueueTypeId");
            ...
            modelBuilder.Entity("DatabaseContext.TransferPointsQueueType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TransferPointsQueueType");
                });
            ...
            modelBuilder.Entity("DatabaseContext.TransferPointsQueue", b =>
                {
                    ...
                    b.HasOne("DatabaseContext.TransferPointsQueueType", "TransferPointsQueueType")
                        .WithMany("TransferPointsQueue")
                        .HasForeignKey("TransferPointsQueueTypeId")
                        .HasConstraintName("FK_TransferPointsQueue_TransferPointsType_TransferPointsTypeId");

                    b.Navigation("Organization");

                    b.Navigation("TransferPointsQueueType");
                });
