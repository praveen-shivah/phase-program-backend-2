...
namespace DataModelsLibrary.Migrations
{
    ...
    [Migration("20230211134912_Switching to db first")]
    partial class Switchingtodbfirst
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseContext.ResellerVendorBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex(new[] { "OrganizationId" }, "IX_ResellerVendorBalance_OrganizationId");

                    b.HasIndex(new[] { "ResellerId" }, "IX_ResellerVendorBalance_ResellerId");

                    b.HasIndex(new[] { "VendorId" }, "IX_ResellerVendorBalance_VendorId");
            ...
            modelBuilder.Entity("DatabaseContext.ResellerVendorBalance", b =>
                {
                    b.HasOne("DatabaseContext.Organization", "Organization")
                        .WithMany("ResellerVendorBalance")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DatabaseContext.Organization", b =>
                {
                    ...
                    b.Navigation("ResellerVendorBalance");
