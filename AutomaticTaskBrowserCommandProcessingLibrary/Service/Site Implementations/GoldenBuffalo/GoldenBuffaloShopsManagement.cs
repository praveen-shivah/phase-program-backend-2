namespace AutomaticTaskBrowserCommandProcessingLibrary
{
    ...
    public class GoldenBuffaloShopsManagement : BaseManagementPage
    {
        ...
        private readonly By agentAccountsSearchInputLocator = By.Id("txtAccounts");
        private readonly By agentAccountSearchButtonLocator = By.XPath("//*[@id=\"btnQuery\"]");
        ...
        public GoldenBuffaloShopsManagement(IWebDriver driver)
            : base(driver)
        {
